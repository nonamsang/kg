...
public class CommunityController {
	...
	public ResponseEntity<?> inserting(
	...
	public String mycommunity(@RequestParam("muserId") int user_Id, Model model) {
		ArrayList<CommunityVO> vo;
		vo = communityService.selectUserCommunity(user_Id);
	...
	public ResponseEntity<?> updatecommunity(
	        ...
	        @RequestParam("title") String title,
	        @RequestParam("content") String content,
	        @RequestParam(value="photoPath", required=false) String photourl) {
	...
	public ResponseEntity<?> del(@RequestParam("id") int id, @RequestParam("user_Id") int user_Id){
		CommunityVO vo=new CommunityVO();
		vo.setId(id);
		vo.setUser_Id(user_Id);
	...
	public ResponseEntity<?> how(@RequestParam("user_Id") int user_Id, @RequestParam("community_Id") int community_Id,
	...
	public ResponseEntity<?> wuw(@RequestParam("id") int id, @RequestParam("user_Id") int user_Id,
			@RequestParam("community_Id") int community_Id, @RequestParam("comment_Id") String comment_Id) {
	...
	public ResponseEntity<?> wwww(@RequestParam("id") int id, @RequestParam("user_Id") int user_Id,
			@RequestParam("community_Id") int community_Id, HttpSession session) {
		CommentVO vo = commentService.selectOneComment(id);
	...
	@ResponseBody
	public ResponseEntity<?> wwwww(@RequestParam("community_Id") int id,@RequestParam("user_Id") int user_Id){
		CommunityVO vo = communityService.selectOneCommunity(id);
		vo.setUser_Id(user_Id);
	...
	@ResponseBody
	public ResponseEntity<?> likeComment(@RequestParam("user_Id") int user_Id, @RequestParam("id") int id){
		CommentVO vo=commentService.selectOneComment(id);
		vo.setUser_Id(user_Id);
