...
public class StockController {
    ...
    public static class GiveRequest {
        ...
        public int getHavewater() { return havewater; }
        public void setHavewater(int havewater) { this.havewater = havewater; }

        public int getWater_Stock() { return water_Stock; }
        public void setWater_Stock(int water_Stock) { this.water_Stock = water_Stock; }
    }
